...
<div class="postbox">
<div class="handlediv" title="<?php _e('Click to toggle', 'fdx-lang') ?>"><br /></div><h3 class='hndle'><span><?php echo FDX3_PLUGIN_NAME;?> <small style="float: right">v<?php echo FDX3_PLUGIN_VERSION;?></small></span></h3>
...
<a class="sm_button sm_autor" href="<?php echo FDX3_PLUGINPAGE;?>" target="_blank"><?php _e('Plugin Homepage', 'fdx-lang') ?></a>
<a class="sm_button sm_code" href="<?php echo FDX3_SUPFORUM;?>" target="_blank"><?php _e('Suggest a Feature', 'fdx-lang') ?></a>
<a class="sm_button sm_bug" href="<?php echo FDX3_SUPFORUM;?>" target="_blank"><?php _e('Report a Bug', 'fdx-lang') ?></a>
<a class="sm_button sm_lang" href="<?php echo FDX3_GLOTPRESS;?>" target="_blank"><?php _e('Help translating it', 'fdx-lang') ?></a>
</div>
</div>
...
<ul>
<li><a class="sm_button sm_star" href="<?php echo FDX3_WPPAGE;?>" target="_blank"><?php _e('Rate the plugin 5 star on WordPress.org', 'fdx-lang') ?>.</a></li>
<li><a class="sm_button sm_link" href="<?php echo FDX3_PLUGINPAGE ;?>" target="_blank"><?php _e('Blog about it and link to the plugin page', 'fdx-lang') ?>.</a></li>
</ul>

<div align="center">
<a href="javascript:void(0);" onclick="PopupCenter('http://www.facebook.com/sharer.php?u=<?php echo FDX3_PLUGINPAGE;?>&t=<?php echo FDX3_PLUGIN_NAME;?>:', 'facebook',800,550,'no');" title="<?php _e('Share on', 'fdx-lang') ?> Facebook" rel="nofollow"><img src="<?php echo FDX3_PLUGIN_URL;?>/images/facebook.png" width="24" height="24" border="0"  alt="*" style="margin-right: 10px" /></a>
<a href="javascript:void(0);" onclick="PopupCenter('http://twitter.com/share?text=Plugin <?php echo FDX3_PLUGIN_NAME;?>:&amp;url=<?php echo FDX3_PLUGINPAGE;?>', 'twitter',600,450,'no');" title="<?php _e('Share on', 'fdx-lang') ?> Twitter" rel="nofollow"><img src="<?php echo FDX3_PLUGIN_URL;?>/images/twitter.png" width="24" height="24" border="0" alt="*" style="margin-right: 10px" /></a>
<a href="javascript:void(0);" onclick="PopupCenter('https://plus.google.com/share?url=<?php echo FDX3_PLUGINPAGE;?>', 'googleplus',800,550,'no');" title="<?php _e('Share on', 'fdx-lang') ?> Google Plus" rel="nofollow"><img src="<?php echo FDX3_PLUGIN_URL;?>/images/googleplus.png" width="24" height="24" border="0" alt="*" /></a>
</div>
</div>
</div>
...
<p><?php _e('If you find any spelling error in this translation or would like to contribute', 'fdx-lang') ?>, <a href="<?php echo FDX3_GLOTPRESS;?>" target="_blank"><?php _e('click here', 'fdx-lang') ?>.</a></p>
