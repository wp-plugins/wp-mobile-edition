...
?><a href="<?php echo get_day_link($arc_year, $arc_month, $arc_day); ?>"><?php the_time( get_option('date_format') ); ?></a></div> <?php next_post_link( '%link', '<span class="fdx_next">'.__('next', 'fdx-lang').' &rsaquo;</span>' ); ?> <?php previous_post_link( '%link', '<span class="fdx_prev">&lsaquo; '.__('prev', 'fdx-lang').'</span>' ); ?>
</div>
...
<div class="rack1"></div> 
<div class="fdx_comments_respond"><?php _e('comments', 'fdx-lang') ?></div>
